...
variable "control_plane_subnet_1_vpc_cidr_block" {
    type = string
    description = "The CIDR block for 1 of 2 subnets for the control plane."
    # 10.0.0.0 - 10.0.0.255
    default = "10.0.0.0/24"
}

variable "control_plane_subnet_2_vpc_cidr_block" {
    type = string
    description = "The CIDR block for 2 of 2 subnets for the control plane."
    # 10.0.1.0 - 10.0.1.255
    default = "10.0.1.0/24"
}


variable "data_plane_vpc_cidr_block" {
    type = string
...
variable "data_plane_subnet_1_vpc_cidr_block" {
    type = string
...
variable "data_plane_subnet_2_vpc_cidr_block" {
    type = string
